...
We will present tips on managing environments with virtualenv and conda. 

````{tab-set}
```{tab-item} virtualenv
Virtualenv ([https://pypi.org/project/virtualenv/](https://pypi.org/project/virtualenv/)) can be installed with the following command:
